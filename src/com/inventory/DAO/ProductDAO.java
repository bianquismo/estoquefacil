...
public class ProductDAO {
    ...
    public void addFunction(ProductDTO productDTO) {
        try {
            ...
            JOptionPane.showMessageDialog(null, "Produto adicionado e pronto para venda.");
    ...
    public void addPurchaseDAO(ProductDTO productDTO) {
        try {
            ...
            prepStatement.executeUpdate();
            JOptionPane.showMessageDialog(null, "Registro de compra adicionado.");
        } catch (SQLException throwables) {
            throwables.printStackTrace();
        }
    ...
    public void editProdDAO(ProductDTO productDTO) {
        try {
            ...
            prepStatement.executeUpdate();
            prepStatement2.executeUpdate();
            JOptionPane.showMessageDialog(null, "Detalhes de produto atualizados.");
        } catch (SQLException throwables) {
            throwables.printStackTrace();
        }
    }
    ...
    public void deletePurchaseDAO(int ID) {
        try {
            ...
            JOptionPane.showMessageDialog(null, "Transação removida.");
        } catch (SQLException e) {
            e.printStackTrace();
        }
        deleteStock();
    ...
    public void sellProductDAO(ProductDTO productDTO, String username) {
        ...
        try {
            ...
            if (productDTO.getQuantity() > quantity)
                JOptionPane.showMessageDialog(null, "Estoque insuficiente para produto.");
