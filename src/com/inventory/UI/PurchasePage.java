...
public class PurchasePage extends javax.swing.JPanel {
        ...
        private void initComponents() {
                ...
                jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Comprar produto"));
                ...
                if (codeText.getText().equals("") || jDateChooser1.getDate() == null
                        ...
                        try {
                                ...
                                if (resultSet.next()) {
                                        ...
                                        JOptionPane.showMessageDialog(null, "Esse parece ser um produto" +
                                                        " que ainda não foi adicionado.\nAdicione esse produto na seção \"Produtos\" antes de prosseguir.");
        ...
        private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {
                if (purchaseTable.getSelectedRow() < 0)
                        JOptionPane.showMessageDialog(null, "Selecione a transação na tabela.");
                else {
                        ...
                        if (opt == JOptionPane.YES_OPTION) {
                                new ProductDAO().deletePurchaseDAO(
                                                (int) purchaseTable.getValueAt(purchaseTable.getSelectedRow(), 0));
