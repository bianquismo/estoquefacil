...
public class SupplierPage extends javax.swing.JPanel {
        ...
        private void initComponents() {
                ...
                jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Detalhes do fornecedor"));
        ...
        private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {
                if (codeText.getText().equals("") || nameText.getText().equals("")
                        ...
                        JOptionPane.showMessageDialog(this, "Insira todos os detalhes.");
                else {
        ...
        private void editButtonActionPerformed(java.awt.event.ActionEvent evt) {
                if (suppTable.getSelectedRow() < 0)
                        JOptionPane.showMessageDialog(this, "Selecione uma entrada para editar na tabela.");
                else {
                        if (codeText.getText().equals("") || nameText.getText().equals("")
                                        || locationText.getText().equals("") || phoneText.getText().equals(""))
                                JOptionPane.showMessageDialog(this, "Insira todos os detalhes.");
        ...
        private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {
                if (suppTable.getSelectedRow() < 0)
                        JOptionPane.showMessageDialog(this, "Selecione uma entrada da tabela a ser excluída.");
                else {
                        int opt = JOptionPane.showConfirmDialog(
                                        this,
                                        "Excluir esse fornecedor?",
                                        "Confirmação",
                                        JOptionPane.YES_NO_OPTION);
                        if (opt == JOptionPane.YES_OPTION) {
                                new SupplierDAO().deleteSupplierDAO(
                                                suppTable.getValueAt(suppTable.getSelectedRow(), 0).toString());
                                loadDataSet();
                        }
                }
        }
