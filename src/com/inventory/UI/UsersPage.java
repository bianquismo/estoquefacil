...
public class UsersPage extends javax.swing.JPanel {
        ...
        private void initComponents() {
                ...
                entryPanel.setBorder(javax.swing.BorderFactory.createTitledBorder("Detalhes do usuario"));
                ...
                userTypeCombo.setModel(
                                new javax.swing.DefaultComboBoxModel<>(new String[] { "ADMINISTRATOR", "EMPLOYEE" }));
        ...
        private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {
                ...
                if (nameText.getText().equals("") || locationText.getText().equals("")
        ...
        private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {
                if (userTable.getSelectedRow() < 0)
                        JOptionPane.showMessageDialog(null, "Selecione uma entrada da tabela");
                else {
